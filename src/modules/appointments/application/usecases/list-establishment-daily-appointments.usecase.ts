...
export type ListEstablishmentlDailyAppointmentsInput = {
  requesterId: string;
...
export class ListEstablishmentlDailyAppointments {
  ...
  async execute(data: ListEstablishmentlDailyAppointmentsInput) {
